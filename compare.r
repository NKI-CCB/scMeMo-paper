...
model_old <- bcm3.load.results("2-mitosis-model-old", "output_gavetpines_t32_n10_e2", prior_file=prior_file, likelihood_file=likelihood_file, output_filename=output_filename)

variable_summary(model, temperature_ix=11)
variable_summary(model_old, temperature_ix=14)

#sample_ix <- sample(501:1000, 500)
#sample_ix <- 2001:4000
