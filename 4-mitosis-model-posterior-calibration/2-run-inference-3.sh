...
cp /home/bthijssen/finalized-analyses/1-cell-population/4-mitosis-model-posterior-calibration/prior_simulated_data.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/4-mitosis-model-posterior-calibration/likelihood_simulated_data.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/4-mitosis-model-posterior-calibration/model.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/4-mitosis-model-posterior-calibration/config.txt .

/home/bthijssen/bcm3/bin/bcminf -c config.txt --prior=prior_simulated_data.xml --likelihood=likelihood_simulated_data.xml -j 12 -k 8  --output.folder=output_simdata_correctspecified_t24_n100 --progress_update_time=30
