...
cp /home/bthijssen/finalized-analyses/1-cell-population/4-mitosis-model-posterior-calibration/likelihood_simulated_data_misspecified_with_mitosis_timings.xml .
...
/home/bthijssen/bcm3/bin/bcminf -c config.txt --prior=prior_simulated_data_misspecified.xml --likelihood=likelihood_simulated_data_misspecified_with_mitosis_timings.xml -j 12 -k 8  --output.folder=output_simdata_misspecified_with_mitosis_timings_t24_n100 --progress_update_time=30
