...
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/likelihood_eward_noCycArepression.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/model_noCycArepression.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/config20.txt .

/home/bthijssen/bcm3/bin/bcminf -c config20.txt --prior=prior_eward.xml --likelihood=likelihood_eward_noCycArepression.xml -j 12 -k 16  --output.folder=output_eward_noCycArepression_t24n20e2_j12k16 --progress_update_time=30
