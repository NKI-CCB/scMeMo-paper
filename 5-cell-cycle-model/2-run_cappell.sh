...
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/prior_cappell.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/likelihood_cappell.xml .
...
/home/bthijssen/bcm3/bin/bcminf -c config20.txt --prior=prior_cappell.xml --likelihood=likelihood_cappell.xml -j 12 -k 16  --output.folder=output_cappell_t24n20e2_j12k16 --progress_update_time=30
