...
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/prior_barr2016.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/likelihood_barr2016.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/model.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/config50.txt .

/home/bthijssen/bcm3/bin/bcminf -c config50.txt --prior=prior_barr2016.xml --likelihood=likelihood_barr2016.xml -j 12 -k 16  --output.folder=output_barr2016_t24n50e2_j12k16 --progress_update_time=30
