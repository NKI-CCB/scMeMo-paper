...
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/prior_akopyan.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/likelihood_akopyan.xml .
...
/home/bthijssen/bcm3/bin/bcminf -c config50.txt --prior=prior_akopyan.xml --likelihood=likelihood_akopyan.xml -j 12 -k 16  --output.folder=output_akopyan_t24n50e2_j12k16 --progress_update_time=30
