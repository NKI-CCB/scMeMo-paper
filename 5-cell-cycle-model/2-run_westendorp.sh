...
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/prior_westendorp.xml .
cp /home/bthijssen/finalized-analyses/1-cell-population/5-cell-cycle-model/likelihood_westendorp.xml .
...
/home/bthijssen/bcm3/bin/bcminf -c config20.txt --prior=prior_westendorp.xml --likelihood=likelihood_westendorp.xml -j 12 -k 16  --output.folder=output_westendorp_t24n20e2_j12k16 --progress_update_time=30
